...
def get_hexagonal_bs(radius=2000):
    ...
    for i in range(6):
        ...
        # Distance between one cell to another cell centers is sqrt(3) * radius
...
def get_random_users(n=100, area_range=5000):
    ...
    area_range=5000 keeps them mostly inside the 7-cell cluster.
    """
...
if __name__ == "__main__":
    ...
    ue_coords = get_random_users(n=100, area_range=5000) # Grid spans -5000 to 5000
